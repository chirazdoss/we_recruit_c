...
const P4 = () => {
 return (
    <div  class=" bg-lightt ">
        ...
        <div class="content" >
        <center>
            <h1 class='text-color'>Comment postuler efficacement ?</h1>
            <img src={img4} class='img-page1  p-4' alt="postuler" />
        </center>
        <p>Toutefois, il y a ceux ou celles qui postulent par hasard sans même poser la question sur le profil demandé par le recruteur.
  <br/>
    Cependant, le Recruteur lui-même peut faire appel à un candidat même si ce dernier ne correspond pas totalement au profil recherché.
      <br/>
    Les questions qui se posent à ce niveau :  <br/>
    Comment mettre toutes les chances de son côté afin de ne pas laisser passer l’opportunité ?  <br/>
Comment postulé à un emploi même sans l’expérience demandée ?  <br/>

</p>
<p>Ci-dessous les démarches à suivre pour maximiser les chances de la réussite d’un entretien d’embauche.</p>
<h2>Etre professionnel dans sa recherche d’emploi</h2>
<p>La postulation par hasard ou sans l’expérience demandée ne justifie « pas du tout » de partir « perdant » à la rencontre du Recruteur.
  <br/>
    Ce n’est pas parce que vous ne disposez pas « totalement » de profil demandé que vous ne puissiez pas occuper le poste à pourvoir.</p>
  <br/>
...
<p>Après avoir réussir votre entretien téléphonique et que vous avez décrochez un rendez-vous avec le Recruteur.

    Maintenant, l’étape suivante consiste à valoriser votre offre de compétences.
    
    La question qui se pose à ce niveau est :
      <br/>
    Comment convaincre un recruteur potentiel et à lui exposer ses points forts ?  <br/>
    La manière est simple et facile.
    
    Vous connaissez le recruteur et vous connaissez le poste à pourvoir.
...
<h2>Chaque candidat doit : Se découvrir lui-même.</h2>
<p>
    Prendre conscience de ses idées, de ses capacités, de ses compétences.
...
<h2>Mettre en avant ses points forts et sa motivation</h2>
<p>
    Nous sommes convaincues que les diplômes et les expériences sont importants mais se sont pas prioritaires.

Ce qui est important aux yeux d’un recruteur c’est la motivation.
...
Le choix entre c’est deux commerciaux ça sera le deuxième cas même s’il ne correspondait pas aux critères établis.

Parce qu’il fait sentir au recruteur une énorme motivation pour réussir.
...
<h2>En entretien .. Soyez vous-même</h2>
<p>
...
Si vous êtes un débutant et vous souhaitez être embauché dans un poste de commercial ; il est inutile d’argumenter votre choix par des phrases comme :

« J’aime parler aux gens ; je suis aimable ; j’ai des connaissances…. ».
